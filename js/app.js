...
angular.module('ToDoApp', ['ui.bootstrap'])
    .config(function($httpProvider) {
        ...
        $httpProvider.defaults.headers.common['X-Parse-Application-Id'] = 'Ca8aPQJG96MmUGoliUYHTXHBtLPPRx38hLc49kJ0';
        $httpProvider.defaults.headers.common['X-Parse-REST-API-Key'] = 'PwOrQRYkVcK6ZBLHju0xdgdhZj9XhWrJJTD2n3Hh';
    })
       ...
       $scope.refreshTasks = function() {
        ...
        $scope.updateTask = function(task) {
            $http.put(tasksUrl + '/' + task.objectId, task)
                .success(function() {
                    //we could give feedback to user
